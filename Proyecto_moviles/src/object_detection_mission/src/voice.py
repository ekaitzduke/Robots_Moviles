...
VALID_COMMANDS = [
    ...
    "detener", "cocina", "comedor", "habitación",
    "finalizar", "visual", "voz", "ambas", "reanudar"
]
...
def listen_and_publish():
    ...
    pub = rospy.Publisher('/turtlebot2/voice_commands', String, queue_size=10)

    # Ruta al modelo de Vosk (ajustar según tu configuración)
    vosk_model_path = "/home/turtlebot/catkin_ws/src/turtlebot2_pkg/vosk-model-small-es-0.42"
